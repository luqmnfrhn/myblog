<x-app-layout>
    <div class="mx-auto max-w-2xl">
        <div class="mb-8">
            <p class="mb-1 text-sm text-stone-400">Reading circle for</p>
            ...
            <p class="mt-3 text-sm text-stone-400">{{ $circle->members->count() }} {{ \Illuminate\Support\Str::plural('member', $circle->members->count()) }}</p>
        </div>
        ...
        <form method="POST" action="{{ route('circles.messages.store', $circle) }}" class="border-t border-stone-200 pt-4">
            ...
            <div class="flex gap-3">
                <input name="body" type="text" placeholder="Share your thoughts..." class="flex-1 rounded-md border border-stone-200 px-4 py-2 text-sm focus:border-accent focus:outline-none">
